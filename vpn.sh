...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/lesta-2/scc/main/vars.conf"
# edit projek export KEY_NAME="vpnstores"
# Save dan keluar dari editor

# install openvpn
wget -O /etc/openvpn/vpn.zip "https://raw.githubusercontent.com/lesta-2/scc/main/vpn.zip"
cd /etc/openvpn/
wget https://raw.githubusercontent.com/lesta-2/scc/main/dh2048.pem
unzip vpn.zip
rm -f vpn.zip
cd
